...
def main():
    ...
    gt_azimuth_odometry = gt_azimuth_poses @ repeated_gt_world_reference
    intra_errors = pose_errors(selected_odometry, gt_azimuth_odometry)
    intra_distances = np.linalg.norm(gt_azimuth_odometry[:, :3, 3], axis=1)
    print_error_stats(
